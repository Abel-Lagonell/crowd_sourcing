...
def printLargeVehicleRegimeTestingData():
	...
	axs[0].plot(Ns2,nOfIterations2)
	axs[1].plot(Ns2,targetUtilities2)
	...
	axs2[0].plot(Ns2, platformUperR2)
	axs2[1].plot(Ns2,vUtility2)
	...
	plt.plot(Ns2,maxUtility2)
	plt.plot(Ns2,minUtility2)
